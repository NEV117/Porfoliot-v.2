        ...
        <div id="gists" class="flex flex-col lg:px-6 lg:py-4 w-full overflow-hidden">
          ...
          <div class="flex flex-col overflow-scroll">
            ...
            <template v-if="folder === 'experience'">
              ...
              <p data-aos="fade-down" class="text-white">Experience folder content :)</p>
            </template>
            <template v-else-if="folder === 'hard-skills'">
              <!-- Custom content for 'hard-skills' folder -->
              <p data-aos="fade-down" class="text-white">Hard skills folder content :)</p>
            </template>
            <template v-else-if="folder === 'soft-skills'">
              <!-- Custom content for 'soft-skills' folder -->
              <p data-aos="fade-down" class="text-white">Soft skills folder content :)</p>
            </template>
            <template v-else>
              <!-- title -->
